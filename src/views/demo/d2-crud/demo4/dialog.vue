<!--<template>-->
    <el-button type="primary" @click="outerVisible = true" icon="fa fa-plus">新增</el-button>
                        ...
                        <el-tab-pane label="基本信息" name="first">
                            <el-form ref="form" :model="form" label-width="80px" :inline="true">
                                ...
                                <el-form-item label="验证方式" class="ml20">
                                    <el-select v-model="form.region" placeholder="请选择验证方式" style="width: 180px">
                                        <el-option label="密码验证" value="shanghai"></el-option>
                                        <el-option label="证书验证" value="beijing"></el-option>
                                    </el-select>
                                </el-form-item>
                                <el-form-item label="备注" style="width: 900px" class="ml20">
